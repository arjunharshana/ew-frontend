  ...
  return (
    <div className="h-screen w-screen flex flex-col overflow-hidden bg-slate-50">
      ...
      <main className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden p-4 md:px-7 md:py-3.5 flex flex-col gap-3.5">
        ...
        <div className="flex flex-col lg:flex-row gap-3.5 flex-none lg:flex-[3_1_0%]">
          {/* Main Panel */}
          <div className="flex-1 flex flex-col gap-3.5 min-w-0">
            <TacticalSpectrumStrip state={sim.state} />
            <div className="bg-white border border-slate-200 rounded-2xl shadow-sm flex-1 flex flex-col min-h-[300px] lg:min-h-[250px] p-4 lg:p-[18px]">
              <FrequencyActivity
        ...
        {/* Performance */}
        <div className="flex flex-col lg:flex-row gap-3.5 flex-none lg:flex-[2_1_0%]">
          ...
          <div className="flex-1 bg-white border border-slate-200 rounded-2xl shadow-sm p-4 lg:px-5 lg:pt-3.5 lg:pb-2.5 min-h-[250px] lg:min-h-[200px]">
